import{o,c as p,b as n,a as t,d as s,e,_ as c}from"./app.18624a7b.js";const l=n("h1",{id:"custom-theme",tabindex:"-1"},[s("Custom theme "),n("a",{class:"header-anchor vp-link",href:"#custom-theme","aria-hidden":"true"},"#")],-1),i=n("p",null,"Hozon Element Plus uses BEM-styled CSS so that you can override styles easily. But if you need to replace styles at a large scale, e.g. change the theme color from blue to orange or green, maybe overriding them one by one is not a good idea.",-1),u=n("p",null,"We provide four ways to change the style variables.",-1),r=n("h2",{id:"change-theme-color",tabindex:"-1"},[s("Change theme color "),n("a",{class:"header-anchor vp-link",href:"#change-theme-color","aria-hidden":"true"},"#")],-1),k=n("p",null,"These are examples about custom theme.",-1),d=s("Full import: "),m={href:"https://github.com/element-plus/element-plus-vite-starter",class:"vp-link",target:"_blank",rel:"noopener noreferrer"},h=s("element-plus-vite-starter"),_=s("On demand: "),g={href:"https://github.com/element-plus/unplugin-element-plus",class:"vp-link",target:"_blank",rel:"noopener noreferrer"},v=s("unplugin-element-plus/examples/vite"),f=n("h3",{id:"by-scss-variables",tabindex:"-1"},[s("By SCSS variables "),n("a",{class:"header-anchor vp-link",href:"#by-scss-variables","aria-hidden":"true"},"#")],-1),b=n("code",null,"theme-chalk",-1),y=s(" is written in SCSS. You can find SCSS variables in "),w={href:"https://github.com/element-plus/element-plus/blob/dev/packages/theme-chalk/src/common/var.scss",class:"vp-link",target:"_blank",rel:"noopener noreferrer"},S=n("code",null,"packages/theme-chalk/src/common/var.scss",-1),C=s("."),x={class:"warning custom-block"},I=n("p",{class:"custom-block-title"},"WARNING",-1),T=s("We use sass modules ("),P={href:"https://sass-lang.com/documentation/values/maps",class:"vp-link",target:"_blank",rel:"noopener noreferrer"},E=s("sass:map"),q=s("...) and "),A=n("code",null,"@use",-1),V=s(" to refactor all SCSS variables. And by using "),z=n("code",null,"@use",-1),N=s(" to all SCSS variables, it solves the duplicate output problem caused by "),B=n("code",null,"@import",-1),W=s("."),j={href:"https://css-tricks.com/introducing-sass-modules/",class:"vp-link",target:"_blank",rel:"noopener noreferrer"},D=s("Introducing Sass Modules | CSS-TRICKS"),R=n("p",null,[s("For example, We use "),n("code",null,"$colors"),s(" as a map to preserve different types of colors.")],-1),U=n("p",null,[n("code",null,"$notification"),s(" is a map where all variables of the "),n("code",null,"notification"),s(" component at.")],-1),$=s("In the future, we will write documentation for variables that can be customized for each component. You can also directly checkout the source "),H={href:"https://github.com/element-plus/element-plus/blob/dev/packages/theme-chalk/src/common/var.scss",class:"vp-link",target:"_blank",rel:"noopener noreferrer"},O=s("var.scss"),Y=s("."),F=e(`<div class="language-scss"><pre><code><span class="token property"><span class="token variable">$colors</span></span><span class="token punctuation">:</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token statement keyword">!default</span><span class="token punctuation">;</span>
...
<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre></div><h3 id="how-to-override-it" tabindex="-1">How to override it? <a class="header-anchor vp-link" href="#how-to-override-it" aria-hidden="true">#</a></h3><p>If your project also uses SCSS, you can directly change Hozon Element Plus style variables. Create a new style file, e.g. <code>styles/element/index.scss</code>:</p>`,3),M={class:"warning custom-block"},G=n("p",{class:"custom-block-title"},"WARNING",-1),L=n("p",null,[s("You should use "),n("code",null,"@use 'xxx.scss' as *;"),s(" instead of "),n("code",null,"@import 'xxx.scss';"),s(".")],-1),K=n("p",null,[s("Because the sass team said they will remove "),n("code",null,"@import"),s(" eventually.")],-1),J={href:"https://sass-lang.com/documentation/at-rules/use",class:"vp-link",target:"_blank",rel:"noopener noreferrer"},Q=s("Sass: @use"),X=s(" vs "),Z={href:"https://sass-lang.com/documentation/at-rules/import",class:"vp-link",target:"_blank",rel:"noopener noreferrer"},nn=s("Sass: @import"),sn=e(`<div class="language-scss"><pre><code><span class="token comment">// styles/element/index.scss</span>
<span class="token comment">/* just override what you need */</span>
<span class="token keyword">@forward</span> <span class="token string">&#39;hozon-element-plus/theme-chalk/src/common/var.scss&#39;</span> <span class="token module-modifier keyword">with</span> <span class="token punctuation">(</span>
...
</code></pre></div><p>Then in the entry file of your project, import this style file instead of Element&#39;s built CSS:</p><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>Import <code>element/index.scss</code> before scss of hozon-element-plus to avoid the problem of sass mixed variables, because we need generate light-x by your custom variables.</p></div><p>Create a <code>element/index.scss</code> to combine your variables and variables of hozon-element-plus. (If you import them in ts, they will not be combined.)</p><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>In addition, you should distinguish your scss from the element variable scss. If they are mixed together, each hot update of <code>hozon-element-plus</code> needs to compile a large number of scss files, resulting in slow speed.</p></div><div class="language-ts"><pre><code><span class="token keyword">import</span> <span class="token punctuation">{</span> createApp <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;vue&#39;</span>
<span class="token keyword">import</span> <span class="token string">&#39;./styles/element/index.scss&#39;</span>
<span class="token keyword">import</span> Hozon <span class="token keyword">from</span> <span class="token string">&#39;hozon-element-plus&#39;</span>
<span class="token keyword">import</span> App <span class="token keyword">from</span> <span class="token string">&#39;./App.vue&#39;</span>

<span class="token keyword">const</span> app <span class="token operator">=</span> <span class="token function">createApp</span><span class="token punctuation">(</span>App<span class="token punctuation">)</span>
app<span class="token punctuation">.</span><span class="token function">use</span><span class="token punctuation">(</span>HozonElementPlus<span class="token punctuation">)</span>
